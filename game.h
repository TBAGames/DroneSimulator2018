...
namespace game {
    ...
    class Game {
        ...
        private:
			...
			bird *CreateBirdInstance(std::string entity_name, std::string object_name, std::string material_name, std::string texture_name, glm::vec3 origin_point, SceneNode * player);
